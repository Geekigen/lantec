				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Top listed Products</h3>
							<div class="row">
					...
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							...
							<form action="/search" method="GET">
								<input type="search" placeholder="i am looking for.." name="search" required="">
								<input type="submit" value=" ">
							</form>
						</div>
						<!-- price -->
						<div class="range border-bottom py-2">
							<h3 class="agileits-sear-head mb-3">Sort by:</h3>
							<div class="w3l-range">
								<ul>
									<li>
										<a href="/low">price low to high</a>
									</li>
									<li class="my-1">
										<a href="/high">price high to low</a>
									</li>
									<li>
